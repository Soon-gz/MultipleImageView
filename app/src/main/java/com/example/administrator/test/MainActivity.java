...
//        imgs.add("http://userimage8.360doc.com/17/0118/19/156649_201701181902460952150615.jpg");
        ...
        imgs1.add("http://upload.chinaz.com/2015/1103/1446540614989.jpg");
        imgs1.add("http://userimage8.360doc.com/16/0519/19/156649_201605191906460585727460.jpg");
        imgs1.add("http://img.sinmeng.com/2017/01/18/1_151219124049_2.jpg");
        imgs1.add("http://joymepic.joyme.com/article/uploads/20163/111460364908999742.jpeg?imageView2/1");
        imgs1.add("http://joymepic.joyme.com/article/uploads/20163/111460364909699286.jpeg?imageView2/1");

        multiImageView1 = (MultiImageView) findViewById(R.id.multiImage1);
        multiImageView1.setList(imgs1);

    }
    public void click(View view){
        startActivity(new Intent(this,ManyMultiActivity.class));
    }
}
